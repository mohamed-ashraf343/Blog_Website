<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="{{route('dashbord.settings')}}"><i class="icon-speedometer"></i> {{__('words.dashbord')}} <span class="tag tag-info">جدید</span></a>
            </li>
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="{{ route('dashbord.category.index') }}"><i
                                class="icon-people"></i>
                            {{ __('words.categories') }}</a>
                    </li>
                </ul>
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="{{ route('dashbord.posts.index') }}"><i
                                class="icon-people"></i>
                            {{ __('words.posts') }}</a>
                    </li>
                </ul>
             ...
             <li class="nav-item">
                <a class="nav-link" href="{{route('dashbord.settings')}}"><i class="icon-people"></i> {{trans('words.settings')}}</a>
            </li>
